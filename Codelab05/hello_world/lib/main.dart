...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Flutter Plugin Praktikum',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: const MyHomePage(title: 'Praktikum Plugin auto_size_text'),
    );
  }
}
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            // --- WIDGET DARI TUGAS PRAKTIKUM ---
            
            // 1. Menggunakan RedTextWidget (AutoSizeText)
            // Lebar 50 sangat sempit, memaksa teks mengecil atau memotong.
            const Text('Teks dengan AutoSizeText (Lebar 50):'),
            Container(
            ...
            // 2. Menggunakan Text standar
            // Lebar 100, teks mungkin terpotong atau meluap.
            const Text('Teks Standar (Lebar 100):'),
            Container(
                color: Colors.greenAccent,
                width: 100,
                child: const Text(
                       'You have pushed the button this many times:',
                       // Tambahkan pengaturan agar terlihat perbedaannya
                       maxLines: 2,
                       overflow: TextOverflow.ellipsis,
